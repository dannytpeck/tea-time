...
Player = function (game, x, y, name) {
    ...
    this.animations.add('fall',     ['fall001', 'fall002', 'fall003', 'fall004'], fps, false);
    ...
    this.animations.add('grabwall', ['grabwall001', 'grabwall002', 'grabwall003', 'grabwall004', 'grabwall005', 'grabwall006', 'grabwall007', 'grabwall008', 'grabwall009', 'grabwall010', 'grabwall011', 'grabwall012', 'grabwall013', 'grabwall014' ], fps, false);
    this.animations.add('climbwall',['climbwallup001', 'climbwallup002', 'climbwallup003', 'climbwallup004', 'climbwallup005'], fps, true);
    ...
    this.actionButton = game.input.keyboard.addKey(Phaser.Keyboard.F);
...
Player.prototype.Standing = function() {
    ...
    } else if(this.states.grabbingWall) {
        this.state = this.Wallgrabbing;
    }
};
...
Player.prototype.Wallgrabbing = function() {
    this.PlayAnim('grabwall');
    
    if(this.animations.currentAnim.isFinished) {
        this.state = this.Wallclimbing;
    }
};

Player.prototype.Wallclimbing = function() {
    this.PlayAnim('climbwall');
...
Player.prototype.openWindow = function() {
    ...
    this.text = this.game.add.text(10, 10, "", this.textStyle);
